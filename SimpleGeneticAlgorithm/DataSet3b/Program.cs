namespace DataSet3b
{
    ...
    public class Program
    {
        ...
        {
            AppSettingsHelper.UpdateAppSettings("PopulationSize", "100");
        ...
        private static IDictionary<IList<double>, int> ArrangeTestingData()
        {
            ...
            var trainingData = dataHandler.ReadRoundedRealData(Environment.CurrentDirectory + filePath);
        ...
        private static void Finalise()
        {
            ...
            var writeFull = dataHandler.TryWriteData(fullBuilder.ToString(), @"G:\University\Final Year\Advances in Artificial Intelligence\Assignment\Data3b\Results_" + ticks + ".csv");
            var writeTest = dataHandler.TryWriteData(testingBuilder.ToString(), @"G:\University\Final Year\Advances in Artificial Intelligence\Assignment\Data3b\TestResult_" + ticks + ".txt");
            var writeRules = dataHandler.TryWriteData(ruleBuilder.ToString(), @"G:\University\Final Year\Advances in Artificial Intelligence\Assignment\Data3b\RuleResult_" + ticks + ".csv");
